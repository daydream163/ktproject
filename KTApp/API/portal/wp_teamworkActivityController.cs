...
namespace KTApp.Controllers
{
    ...
    public class wp_teamworkActivityController : ControllerBase
    {
        private readonly ILogger<wp_teamworkActivityController> _logger;

        public wp_teamworkActivityController(ILogger<wp_teamworkActivityController> logger)
        {
            _logger = logger;
        }
        ...
        {
            string returnstr = "";
            string page = "wp_teamworkActivity";
