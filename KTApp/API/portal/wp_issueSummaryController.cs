...
namespace KTApp.Controllers
{
    ...
    public class wp_issueSummaryController : BaseApiController
    {
        private readonly ILogger<wp_issueSummaryController> _logger;

        public wp_issueSummaryController(ILogger<wp_issueSummaryController> logger)
        {
            _logger = logger;
        }
