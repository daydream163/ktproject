...
{
    public class wp_headlineController : BaseApiController
    {
        private readonly ILogger<wp_headlineController> _logger;

        public wp_headlineController()
        {
        }
        public wp_headlineController(ILogger<wp_headlineController> logger)
        {
            _logger = logger;
        }
