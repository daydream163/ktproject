...
namespace KTApp.Controllers
{
    ...
    public class wp_myAssignmentsController : ControllerBase
    {
        private readonly ILogger<wp_myAssignmentsController> _logger;

        public wp_myAssignmentsController(ILogger<wp_myAssignmentsController> logger)
        {
            _logger = logger;
        }
