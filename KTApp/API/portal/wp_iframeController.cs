...
namespace KTApp.Controllers
{
    ...
    public class wp_iframeController : BaseApiController
    {
        private readonly ILogger<wp_iframeController> _logger;

        public wp_iframeController(ILogger<wp_iframeController> logger)
        {
            _logger = logger;
        }
