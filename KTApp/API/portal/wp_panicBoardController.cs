...
namespace KTApp.Controllers
{
    ...
    public class wp_panicBoardController : ControllerBase
    {
        private readonly ILogger<wp_panicBoardController> _logger;

        public wp_panicBoardController(ILogger<wp_panicBoardController> logger)
        {
            _logger = logger;
        }
