...
namespace KTApp.Controllers
{
    ...
    public class wp_summaryBarController : ControllerBase
    {
        private readonly ILogger<wp_summaryBarController> _logger;

        public wp_summaryBarController(ILogger<wp_summaryBarController> logger)
        {
            _logger = logger;
        }
