...
namespace KTApp.Controllers
{
    ...
    public class wp_welcomeController : ControllerBase
    {
        private readonly ILogger<wp_welcomeController> _logger;

        public wp_welcomeController(ILogger<wp_welcomeController> logger)
        {
            _logger = logger;
        }
