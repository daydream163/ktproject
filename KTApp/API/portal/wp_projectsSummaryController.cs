...
namespace KTApp.Controllers
{
    ...
    public class wp_projectsSummaryController : ControllerBase
    {
        private readonly ILogger<wp_projectsSummaryController> _logger;

        public wp_projectsSummaryController(ILogger<wp_projectsSummaryController> logger)
        {
            _logger = logger;
        }
        ...
        {
            string returnstr = "";
            string page = "wp_projectsSummary";
