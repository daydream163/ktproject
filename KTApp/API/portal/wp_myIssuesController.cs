...
namespace KTApp.Controllers
{
    ...
    public class wp_myIssuesController : ControllerBase
    {
        private readonly ILogger<wp_myIssuesController> _logger;

        public wp_myIssuesController(ILogger<wp_myIssuesController> logger)
        {
            _logger = logger;
        }
