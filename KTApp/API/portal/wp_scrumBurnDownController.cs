...
namespace KTApp.Controllers
{
    ...
    public class wp_scrumBurnDownController : ControllerBase
    {
        private readonly ILogger<wp_scrumBurnDownController> _logger;

        public wp_scrumBurnDownController(ILogger<wp_scrumBurnDownController> logger)
        {
            _logger = logger;
        }
