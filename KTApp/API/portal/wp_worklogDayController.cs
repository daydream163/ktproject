...
namespace KTApp.Controllers
{
    ...
    public class wp_worklogDayController : ControllerBase
    {
        private readonly ILogger<wp_worklogDayController> _logger;

        public wp_worklogDayController(ILogger<wp_worklogDayController> logger)
        {
            _logger = logger;
        }
