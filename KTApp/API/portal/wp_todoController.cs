...
namespace KTApp.Controllers
{
    ...
    public class wp_todoController : ControllerBase
    {
        private readonly ILogger<wp_todoController> _logger;

        public wp_todoController(ILogger<wp_todoController> logger)
        {
            _logger = logger;
        }
