...
namespace KTApp.Controllers
{
    ...
    public class wp_myPlanController : ControllerBase
    {
        private readonly ILogger<wp_myPlanController> _logger;

        public wp_myPlanController(ILogger<wp_myPlanController> logger)
        {
            _logger = logger;
        }
