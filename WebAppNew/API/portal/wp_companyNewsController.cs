...
namespace KTApp.Controllers
{
    ...
    public class wp_companyNewsController : BaseApiController
    {
        private readonly ILogger<wp_companyNewsController> _logger;

        public wp_companyNewsController(ILogger<wp_companyNewsController> logger)
        {
            _logger = logger;
        }
