...
namespace KTApp.Controllers
{
    ...
    public class wp_issuesCreatedByMeController : BaseApiController
    {
        private readonly ILogger<wp_issuesCreatedByMeController> _logger;

        public wp_issuesCreatedByMeController(ILogger<wp_issuesCreatedByMeController> logger)
        {
            _logger = logger;
        }
        ...
        //{
        //    string returnstr = "";
        //    string page = "wp_issuesCreatedByMe";
        ...
        //    return Content( HttpStatusCode.OK, "text/html", Encoding.UTF8);
        //}
/*        [HttpGet]
