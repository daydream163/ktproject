...
namespace KTApp.Controllers
{
    ...
    public class wp_activityController : BaseApiController
    {
        private readonly ILogger<wp_activityController> _logger;

        public wp_activityController()
        {
        }

        public wp_activityController(ILogger<wp_activityController> logger)
        {
            _logger = logger;
        }
