...
namespace KTApp.Controllers
{
    ...
    public class wp_linksController : BaseApiController
    {
        private readonly ILogger<wp_linksController> _logger;

        public wp_linksController(ILogger<wp_linksController> logger)
        {
            _logger = logger;
        }
