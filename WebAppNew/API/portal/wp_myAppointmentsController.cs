...
namespace KTApp.Controllers
{
    ...
    public class wp_myAppointmentsController : BaseApiController
    {
        private readonly ILogger<wp_myAppointmentsController> _logger;

        public wp_myAppointmentsController(ILogger<wp_myAppointmentsController> logger)
        {
            _logger = logger;
        }
