...
namespace KTApp.Controllers
{
    ...
    public class wp_teamLoadController : ControllerBase
    {
        private readonly ILogger<wp_teamLoadController> _logger;

        public wp_teamLoadController(ILogger<wp_teamLoadController> logger)
        {
            _logger = logger;
        }
