...
namespace KTApp.Controllers
{
    ...
    public class wp_myResponsabilitiesController : ControllerBase
    {
        private readonly ILogger<wp_myResponsabilitiesController> _logger;

        public wp_myResponsabilitiesController(ILogger<wp_myResponsabilitiesController> logger)
        {
            _logger = logger;
        }
        ...
        {
            string returnstr = "";
            string page = "wp_myResponsabilities";
