...
namespace KTApp.Controllers
{
    ...
    public class wp_create_issuesController : BaseApiController
    {
        private readonly ILogger<wp_create_issuesController> _logger;

        public wp_create_issuesController(ILogger<wp_create_issuesController> logger)
        {
            _logger = logger;
        }
